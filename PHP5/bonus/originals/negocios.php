  ...
  <div class="page-wrapper">
    ...
    <main class="main">
      ...
      <div class="banners-carousel owl-carousel owl-theme">
        <div class="">
          <img data-src="assets/images/Negocios-S22Ultra.jpg" alt="Negocios banner" class="owl-lazy">
        </div>
        <div class="">
          <img data-src="assets/images/RS62.jpg" alt="Negocios banner" class="owl-lazy">
        </div>
        <div class="">
          <img data-src="assets/images/Ambiente_KLM_Continental.jpg" alt="Negocios banner" class="owl-lazy">
        </div>
        <div class="">
          <img data-src="assets/images/betic-portada.jpg" alt="Negocios banner" class="owl-lazy">
        </div>
      </div>
